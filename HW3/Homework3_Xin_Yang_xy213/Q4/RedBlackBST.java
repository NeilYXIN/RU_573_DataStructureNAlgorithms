...
public class RedBlackBST<Key extends Comparable<Key>, Value> {
    ...
    ***************************************************************************/
    ...
    /**
     * Using dfs to count internal path length
     *
     * @param node
     * @param currentDepth
    ...
    /**
     * Unit tests, calculate average path length and standard deviation
     *
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int N = 1; N <= 10000; N++) {
            ...
            for (int i = 0; i < 1000; i++) {
                ...
                // calculate the average path length of a random node
                double internalLength = 0;
                if (st.root != null) {
                    internalLength = st.dfs(st.root, 0, internalLength);
            ...
            for (int i = 0; i < 1000; i++) {
                stdDeviationSum += Math.pow((tempRes[i] - averageLength), 2);
            }
            stdDeviation[N - 1] = Math.sqrt(stdDeviationSum / 999);
            System.out.println(N);
            writer.write(String.valueOf(N) + " " + String.valueOf(averageLength) + " " + String.valueOf(stdDeviation[N - 1]) + "\r");
        }
        writer.close();
    }
}
